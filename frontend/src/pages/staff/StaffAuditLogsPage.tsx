...
import { fetchStaffAuditLogs, type StaffAuditLogItem } from "../../services/staff/logsService";
...
export function StaffAuditLogsPage() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      const page = await fetchStaffAuditLogs({
