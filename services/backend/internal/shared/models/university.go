// University models for the unified backend service.
package models
...
// University represents a university row in the shared runtime store.
...
type CreateUniversityRequest struct {
	...
	UniversityProfile    json.RawMessage `json:"university_profile,omitempty"`
