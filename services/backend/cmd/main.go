...
func registerApplicantRoutes(router *mux.Router) {
	...
	router.HandleFunc("/universities/{id}/logo", sharedHandlers.GetUniversityLogoHandler).Methods(http.MethodGet)
...
func registerPartnerRoutes(router *mux.Router) {
	...
	router.HandleFunc("/university/profile/logo", withLinkedUniversityID(sharedHandlers.UpdateUniversityLogoHandler)).Methods(http.MethodPut)
...
func registerStaffRoutes(router *mux.Router, authHandler *authHandlers.AuthHandler) {
	...
	router.HandleFunc("/universities/{id}/logo", sharedHandlers.UpdateUniversityLogoHandler).Methods(http.MethodPut)
