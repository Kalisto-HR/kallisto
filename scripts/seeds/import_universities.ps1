...
function Build-UpsertStatements {
    ...
    foreach ($u in $Universities) {
        ...
        $values = @(
            ...
            (ConvertTo-SqlNumber $u.livingCost),
            (ConvertTo-SqlNumber $u.totalCost),
            ...
            (ConvertTo-SqlText $u.competitiveness),
            (ConvertTo-SqlText $u.cityType),
            (ConvertTo-SqlText $u.safetyLevel),
            (ConvertTo-SqlText $u.campusVibe),
            (ConvertTo-SqlBool $u.visaRequired),
