...
export function ApplicantCheckoutPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <section className="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:gap-4">
        <Button variant="ghost" size="icon" onClick={() => navigate(routes.applicant.basket)}>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button onClick={() => navigate(routes.applicant.basket)}>Back to Basket</Button>
            <Button variant="outline" onClick={() => navigate(routes.applicant.universities)}>
              Browse Universities
            </Button>
          </div>
        </CardContent>
